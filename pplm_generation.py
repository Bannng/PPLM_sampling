...
DISCRIMINATOR_MODELS_PARAMS = {
    ...
    "byeongjoo_toxic_1":{
        'path' : '/home/byeongjoo/works/buildbreakfix/train_classifier_1/toxic_classifier_head_epoch_10.pt',
        'class_size' : 2,
        'embed_size' : 768,
        "class_vocab": {"non_toxic": 0, "toxic": 1},
        "default_class": 1,
        "pretrained_model": "/home/byeongjoo/works/buildbreakfix/model_checkpoint/checkpoint-6600",
    },
    "toxicity_dialog": {
        "url": "https://raw.githubusercontent.com/uber-research/PPLM/master/paper_code/discrim_models/toxicity_classifierhead.pt",
        "class_size": 2,
...
class PPLMGeneration(Pipeline):
    def __init__(self,
        ...
        model = GPT2LMHeadModel.from_pretrained(pretrained_model, output_hidden_states=True).to(self.device)
        model.eval()
        
        # load tokenizer
        if 'byeongjoo' in pretrained_model:
            tokenizer = GPT2Tokenizer.from_pretrained('gpt2', pad_token='<pad>')
            tokenizer.add_special_tokens({'additional_special_tokens': ['<sys>', '<usr>']})
        elif 'DialoGPT' in pretrained_model:
    ...
    def __call__(self,
        ...
        tokenized_cond_text = self.tokenizer.encode(cond_text)
